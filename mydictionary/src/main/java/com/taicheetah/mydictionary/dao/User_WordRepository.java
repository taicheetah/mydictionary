...
public interface User_WordRepository extends JpaRepository<User_Word, User_WordId> {
	...
	Page<User_Word> findAllWordsByUserId(@Param("userId") int userId, Pageable pageable);
	
	@Query("SELECT uw FROM User_Word uw WHERE uw.user_WordId.userId = :userId AND uw.user_WordId.wordName LIKE %:keyWord%")
	Page<User_Word> findAllWordsByUserIdAndWordNameContains(@Param("userId") int userId, @Param("keyWord")String keyWord, Pageable pageable);	
	...
	Page<User_Word> findAllWordsByUserIdAndRememberFlgAndWordNameContains(@Param("userId") int userId, @Param("rememberFlg")boolean rememberFlg, @Param("keyWord")String keyWord, Pageable pageable);
	...
	Page<User_Word> findAllWordsByUserIdAndDateTimeBetweenAndWordNameContains(@Param("userId") int userId, @Param("startDate")Date startDate, @Param("endDate")Date endDate, @Param("keyWord")String keyWord, Pageable pageable);
	...
	Page<User_Word> findAllWordsByUserIdAndRememberFlgAndDateTimeBetweenAndWordNameContains(@Param("userId") int userId, @Param("rememberFlg")boolean rememberFlg, @Param("startDate")Date startDate, @Param("endDate")Date endDate, @Param("keyWord")String keyWord, Pageable pageable);
